import { EndIndex, Source, StartIndex, Token, TokenType } from "./common";
import { GenericState, YieldInstance } from "./rules";
...
export namespace Err {
  ...
  export enum Type {
    ...
    UnclosedTemplateString = "UnclosedTemplateString"
  }
